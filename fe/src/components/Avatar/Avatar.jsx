...
function Avatar({userId, avatarId, fullName, username, email, commentCount, likeCount, postCount, onUserUpdated, isOwnProfile = false}) {
    ...
    return (
        <>
            ...
            <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
                ...
                {/* Name Modal - sadece kendi profilinde açılsın */}
                {isOwnProfile && (
